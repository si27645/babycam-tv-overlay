...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var groupDoorbellDisplayMode: RadioGroup
    ...
    private fun bindViews() {
        ...
        groupDoorbellDisplayMode = findViewById(R.id.group_doorbell_display_mode)
    ...
    private fun populateOptionGroups() {
        ...
        DoorbellDisplayMode.entries.forEach { mode -> groupDoorbellDisplayMode.addView(radioButtonFor(mode.label, mode.ordinal)) }
    ...
    private fun loadSettingsIntoForm() {
        ...
        groupDoorbellDisplayMode.check(settings.doorbellDisplayMode.ordinal)
    ...
    private fun saveAndStart() {
        ...
        val newDoorbellDisplayMode = DoorbellDisplayMode.entries[groupDoorbellDisplayMode.checkedRadioButtonId.coerceAtLeast(0)]
        ...
        val doorbellRelatedChanged = newMqttEnabled != settings.mqttEnabled ||
            ...
            newDoorbellDisplayMode != settings.doorbellDisplayMode ||
        ...
        settings.doorbellDisplayMode = newDoorbellDisplayMode
